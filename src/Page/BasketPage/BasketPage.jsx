...
const HOTEL_ROOMS_URL = "https://api.albanproject.az/api/hotel-room-number/";

// Sifariş POST-ları
const TABLE_BASKETS_POST_URL = "https://api.albanproject.az/api/baskets/";
// const ROOM_BASKETS_POST_URL  = "https://api.albanproject.az/api/room-baskets/"; // istifadə etmirik
const ROOM_ORDERED_POST_URL  = "https://api.albanproject.az/api/room-ordered/";   // yeni API (hotel_room tələb edir)
